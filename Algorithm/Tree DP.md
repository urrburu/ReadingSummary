...
백준2213 트리의 독립집합([링크](http://icpc.me/2213)) 문제를 봅시다. 최대 독립 집합을 구하는 문제입니다.  
...
백준1693 트리 색칠하기([링크](http://icpc.me/1693)) 문제를 봅시다. 트리에 있는 각각의 정점은 어떤 색깔로 칠해질 수 있습니다. dp배열을 아래와 같이 정의합시다.  
`dp[i][j] = i를 루트로 하는 서브트리에서 i를 j로 칠할 때의 정답`

이런 식으로 문제를 해결할 수 있습니다. 두 문제에 대한 자세한 풀이는 ([여기](https://justicehui.github.io/ps/2018/09/10/BOJ2213/), [여기](https://justicehui.github.io/ps/2019/01/05/BOJ1693/))에 있습니다.